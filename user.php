...
<body>      <!-- seção principal -->
    ...
    <section id="principal">
        <section id="topo" style="background-image:url(<?php echo "users/$email_log/$capa_log"; ?>)">     <!-- header -->    <!-- a propriedade 'background-image' permite iserir uma imagem como plano de fundo -->
